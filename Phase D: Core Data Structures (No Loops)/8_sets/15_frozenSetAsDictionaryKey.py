...
for w in words:
    key = frozenset(w)
    groups.setdefault(key, []).append(w)  # TODO: create a hashable key representing letters in w (sorted) using frozenset or tuple
         # TODO: add w into groups under that key

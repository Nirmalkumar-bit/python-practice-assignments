# Define a function named repeat_word that takes:
# - word (string)
# - times (int, default value 2)
# It returns the word repeated 'times' with a single space between repetitions.
# Example: repeat_word("go", 3) -> "go go go"

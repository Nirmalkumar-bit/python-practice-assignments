# Goal: Read user input into variables and print a formatted message.
# Expected output (exactly 1 line, for input 'Mia' and '8'):
...
print(name + " will be " + str(next_age) + " next year.")
